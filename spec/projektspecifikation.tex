...
render & canvas, dc, scrolled distance & ROLF varför render-tile å render?! \\ 
...
Det är banan som säger åt allt som finns i den att rita sig genom att sända proceduranropet update! till varje element på banan. 
 

\subsubsection{Karaktärer}

Karaktärklassen är gemensam för fiender och spelare. Denna klass innehåller metoder som hanterar vad som ska hända när spelaren krockar med något, tar skada, tar upp och byter vapen etc. 

\subsubsection{Skott}

Skotten är objekt som kan avlossas från vapen. Dessa tas bort när de åker utanför den synliga delen av banan för att spara på datorkapacitet. Det tas även bort vid krock med solida tiles samt efter att ha träffat tex. en fiende. 
